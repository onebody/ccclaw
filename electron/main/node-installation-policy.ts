...
const ENV_NODE_MIN_VERSION = 'CCCLAW_NODE_MIN_VERSION'
const ENV_NODE_INSTALL_VERSION = 'CCCLAW_NODE_INSTALL_VERSION'
const ENV_NODE_DIST_BASE_URL = 'CCCLAW_NODE_DIST_BASE_URL'
const ENV_OPENCLAW_METADATA_URL = 'CCCLAW_OPENCLAW_METADATA_URL'
