...
const SHARED_EXTRA_BIN_DIRS_ENV = 'CCCLAW_CLI_EXTRA_BIN_DIRS'
const NODE_EXTRA_BIN_DIRS_ENV = 'CCCLAW_NODE_EXTRA_BIN_DIRS'
const OPENCLAW_EXTRA_BIN_DIRS_ENV = 'CCCLAW_OPENCLAW_EXTRA_BIN_DIRS'
